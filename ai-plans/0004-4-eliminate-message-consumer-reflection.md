...
- [ ] `RabbitMqTopologyCompiler.ValidateServiceRegistrations` validates that the concrete `handler.HandlerType` is registered instead of `IMessageHandler<TMessage>`, with the error message updated accordingly.
